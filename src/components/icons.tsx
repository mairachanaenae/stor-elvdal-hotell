...
export function SceneMoose() {
  return (
    <svg viewBox="0 0 400 320" preserveAspectRatio="xMidYMid slice" aria-hidden>
      <rect width="400" height="320" fill="#1c261f" />
      <g opacity="0.7" fill="#243024">
...
export function SceneGallery() {
  return (
    <svg viewBox="0 0 400 320" preserveAspectRatio="xMidYMid slice" aria-hidden>
      <rect width="400" height="320" fill="#243024" />
      <rect x="30" y="40" width="150" height="110" rx="2" fill="#34505d" stroke="#be8a3e" strokeWidth="4" />
      <path d="M40 140l40-45 30 25 25-30 35 50z" fill="#91aab5" />
      <circle cx="70" cy="70" r="9" fill="#d2a85c" />
      <rect x="220" y="60" width="150" height="180" rx="2" fill="#1c261f" stroke="#be8a3e" strokeWidth="4" />
      <path d="M240 230c0-60 20-110 55-110s55 50 55 110z" fill="#557484" />
      <rect x="40" y="200" width="320" height="14" fill="#a9712f" />
    </svg>
  );
}
